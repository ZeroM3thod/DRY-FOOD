...
export default function SignUpPage() {
  ...
  const [pwStrength, setPwStrength]     = useState({ show: false, pct: '0%', color: '', label: '' })
  ...
  const setError   = (field) => setErrors(e => ({ ...e, [field]: true }))

  /* ─ Password strength ─ */
  const updateStrength = (val) => {
    if (!val) { setPwStrength({ show: false, pct: '0%', color: '', label: '' }); return }
    let score = 0
    ...
    const levels = [
      { pct: '20%', color: '#9B4F1A', label: 'Too weak' },
      { pct: '40%', color: '#C8784A', label: 'Weak'     },
      { pct: '60%', color: '#D4A040', label: 'Fair'     },
      { pct: '80%', color: '#7AAA50', label: 'Good'     },
      { pct: '100%',color: '#2B4A1D', label: 'Strong'   },
    ]
    const lvl = levels[Math.min(score - 1, 4)] ?? levels[0]
    setPwStrength({ show: true, ...lvl })
  }
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      setLoading(false)
      showToast('Welcome to Zestopia! Your account is ready 🌿')
    }, 1800)
  }
        ...
        <aside className="brand-panel">
          ...
          <div className="brand-mid">
            <h1 className="brand-tagline">
              Join the<br/><em>flavour</em> family
            </h1>
            <p className="brand-sub">
              Create your free account and unlock a world of pure spices, authentic masalas, and premium
              dry foods — delivered straight to your door.
            </p>
            ...
            <ul className="brand-features">
              <li>
                ...
                <div className="feat-text">
                  <strong>Personalised Wishlist</strong>
                  <span>Save your favourite blends and never lose track of them</span>
                </div>
              </li>
              <li>
                <div className="feat-icon">
                ...
                <div className="feat-text">
                  ...
                  <span>Saved addresses and payment details for quicker reorders</span>
                </div>
              </li>
              <li>
                <div className="feat-icon">
                ...
                <div className="feat-text">
                  ...
                  <span>Reorder your staples with a single tap, anytime</span>
                </div>
              </li>
              <li>
                <div className="feat-icon">
                ...
                <div className="feat-text">
                  ...
                  <span>Early access to seasonal drops, bundles &amp; exclusive discounts</span>
                </div>
              </li>
            </ul>
          ...
          <div className="brand-quote">
            ...
            <p className="quote-text">
              Signing up took 30 seconds and now I never run out of my favourite masalas — Zestopia has
              completely changed how I cook.
            </p>
            <div className="quote-author">
              <div className="quote-av">N</div>
              <div>
                <div className="quote-name">Nadia Hossain</div>
                <div className="quote-loc">Chittagong, Bangladesh</div>
              </div>
            </div>
          </div>
        </aside>
          ...
          <div className="form-wrap">
            ...
            <div className="form-heading-row">
              <div className="form-eyebrow">
                ...
                <span className="eyebrow-label">New Account</span>
              </div>
              <h2 className="form-title">Create your<br/><em>free</em> account</h2>
            ...
            <div className="form-fields">
              ...
              <div className="field-row">
                ...
                <div className="field-group">
                  ...
                  <span className={`field-error${errors.firstName ? ' show' : ''}`}>
                    <svg viewBox="0 0 24 24">
                      <circle cx="12" cy="12" r="10"/>
                ...
                <div className="field-group">
                  ...
                  <span className={`field-error${errors.lastName ? ' show' : ''}`}>
                    <svg viewBox="0 0 24 24">
                      <circle cx="12" cy="12" r="10"/>
                      <line x1="12" y1="8" x2="12" y2="12"/>
                      <line x1="12" y1="16" x2="12.01" y2="16"/>
              ...
              <div className="field-group">
                ...
                <div className="field-wrap">
                  <input
                    ...
                    ref={passwordRef}
                    onChange={(e) => { clearError('password'); updateStrength(e.target.value) }}
                  />
                  <span className="field-icon">
                    <svg viewBox="0 0 24 24">
              ...
              <div className="field-group">
                ...
                <span className={`field-error${errors.confirmPassword ? ' show' : ''}`}>
                  <svg viewBox="0 0 24 24">
                    <circle cx="12" cy="12" r="10"/>
                    <line x1="12" y1="8" x2="12" y2="12"/>
                    <line x1="12" y1="16" x2="12.01" y2="16"/>
            ...
            <div className="terms-row">
              <label className="check-wrap">
                <input type="checkbox" className="check-input" id="terms" ref={termsRef}/>
                <span className="check-box" />
              </label>
              <span className="terms-text">
                I agree to Zestopia&apos;s{' '}
                <a href="#">Terms of Service</a> and{' '}
                <a href="#">Privacy Policy</a>, and consent to receiving order updates and occasional offers.
              </span>
            </div>
